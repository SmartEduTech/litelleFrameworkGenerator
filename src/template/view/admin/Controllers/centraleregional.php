...
,
            "nomar"=>\Smartedutech\Littlemvc\Langue::getString("Col_nomar") 
,
            "nomfr"=>\Smartedutech\Littlemvc\Langue::getString("Col_nomfr") 
,
            "adress"=>\Smartedutech\Littlemvc\Langue::getString("Col_adress") 
,
            "autreinforegional"=>\Smartedutech\Littlemvc\Langue::getString("Col_autreinforegional") 
...
public function consultercentraleregional(){
        ...
        if(!empty($idcentraleregional)
            ...
            $Vue->liste= $centraleregionalRecs ? $centraleregionalRecs : array();
            $datas=array(
                            "idcentraleregional"=>\Smartedutech\Littlemvc\Langue::getString("idcentraleregional") 
,
            "nomar"=>\Smartedutech\Littlemvc\Langue::getString("nomar") 
,
            "nomfr"=>\Smartedutech\Littlemvc\Langue::getString("nomfr") 
,
            "adress"=>\Smartedutech\Littlemvc\Langue::getString("adress") 
,
            "autreinforegional"=>\Smartedutech\Littlemvc\Langue::getString("autreinforegional") 
